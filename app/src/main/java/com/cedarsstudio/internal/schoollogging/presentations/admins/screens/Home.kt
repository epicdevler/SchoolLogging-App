...
fun Home(
    ...
    ModalNavigationDrawer(
        drawerContent = {
            DrawerContent(drawerState, coroutineScope, drawerScreenItems, onNavigate = { route ->
        ...
        ConstraintLayout(
            ...
            TopAppBar(title = {}, navigationIcon = {
                ...
                IconButton(onClick = { onNavigate(Routings.ADMIN_PROFILE, false) }) {
            ...
            Text("Welcome", modifier = Modifier.constrainAs(welcomeText) {
...
private fun DrawerContent(
    ...
    ConstraintLayout(
        modifier = Modifier
            .fillMaxHeight()
            .background(
                color = MaterialTheme.colorScheme.primary, shape = MaterialTheme.shapes.medium.copy(
